...
import dto.request.response.UserTokenResponse;
...
public final class RestClient {
    ...
    private String getAuthorizationToken() {
        ...
        return "Bearer " + RestAssured.given().body(jsonObject.toMap()).when().contentType(ContentType.JSON)
                .baseUri(BASE_URL)
                .post("Account/V1/GenerateToken").then().statusCode(RESPONSE_OK)
